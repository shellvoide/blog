...
- Use the named methods (`axios.get`, `axios.post`, and so on), which always set the method explicitly.
- Pass the method yourself: `axios.request({ url, method: 'GET' })`.
- Use an instance from `axios.create()` rather than the default object.
...
- axios source, the file this lives in: [`lib/core/Axios.js`](https://github.com/axios/axios/blob/v1.11.0/lib/core/Axios.js)
- The axios project: [github.com/axios/axios](https://github.com/axios/axios)
- Background on the bug class: [Prototype pollution (MDN)](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/proto)
- The check the fix relies on: [`Object.hasOwn()` (MDN)](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/hasOwn)
